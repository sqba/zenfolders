...
// this functions determines which version of IContextMenu is avaibale
// for those objects (always the highest one) and returns that interface
...
LRESULT CALLBACK CShellContextMenu::HookWndProc(HWND hWnd,
												UINT message,
												WPARAM wParam,
												LPARAM lParam)
{
...
HRESULT CShellContextMenu::SHBindToParentEx(LPCITEMIDLIST pidl,
											REFIID riid,
											VOID **ppv,
